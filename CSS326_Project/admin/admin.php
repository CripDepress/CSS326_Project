						...
						<tr>
							...
							<td>
								<a href='edit.php?MovieID=<?=$row['MovieID']?>'>
									<img class="icon" src="/CSS326_Project/_images/Modify.png">
							</td>
							<td>
								<a href='delete.php?MovieID=<?=$row['MovieID']?>'>
									<img class="icon" src="/CSS326_Project/_images/Delete.png">
								</a>
							</td>
						</tr>
						<?php } ?>
				...
				<div class='table-show'>
                    ...
                    while($row=$result->fetch_array()){ ?>
						<tr>
							...
							<td>
								<a href='delete.php?ShowID=<?=$row['ShowID']?>'>
									<img class="icon" src="/CSS326_Project/_images/Delete.png">
								</a>
							</td>
						</tr>
