                    ...
                    <?php
                        ...
                        if(isset($_POST['screening-sub'])) {
                            ...
                            if(!$result){
                                ...
                                $q=
                                'INSERT INTO `screening_seat`(`Status`,`Price`,`CinemaSeatID`,`ShowID`)
                                SELECT 0,IF(cinema_seat.Type = 0, 550, 650),cinema_seat.CinemaSeatID,screening.ShowID
                                FROM cinema_seat INNER JOIN screening ON screening.CinemaHallID = cinema_seat.CinemaHall
                                WHERE ShowID = '.$mysqli -> insert_id.';';
                                if($result=$mysqli->query($q)) {
                                    echo "screening_seat successfully added!" ;
                                }else{
                                    echo "INSERT failed. Error: ".$mysqli->error ;
                                }
                            }
